...
import org.csc.wallet.service.Wallet.ReqGetTxByHash;
import org.csc.wallet.service.Wallet.RespGetBlock;
...
@Deprecated
public class QueryTransactionBlock extends SessionModules<BaseData>{
	...
	public String[] getCmds() {
		return new String[] { PWLTCommand.QTB.name() };
	}
