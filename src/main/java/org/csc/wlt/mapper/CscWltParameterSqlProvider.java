...
import org.csc.wlt.entity.CscWltParameterExample.Criterion;
import org.csc.wlt.entity.CscWltParameterExample;

public class CscWltParameterSqlProvider {
	 ...
	 */
	public String countByExample(CscWltParameterExample example) {
		BEGIN();
		SELECT("count(*)");
		FROM("csc_wlt_parameter");
	 ...
	 * @mbggenerated Fri Jun 08 18:04:10 CST 2018
	 */
	public String deleteByExample(CscWltParameterExample example) {
		BEGIN();
		DELETE_FROM("csc_wlt_parameter");
		applyWhere(example, false);
		return SQL();
	}
	 ...
	 * @mbggenerated Fri Jun 08 18:04:10 CST 2018
	 */
	public String insertSelective(CscWltParameter record) {
		BEGIN();
		INSERT_INTO("csc_wlt_parameter");

		if (record.getParamId() != null) {
			VALUES("param_id", "#{paramId,jdbcType=INTEGER}");
		}

		if (record.getParamCode() != null) {
			VALUES("param_code", "#{paramCode,jdbcType=VARCHAR}");
		}
		...
		if (record.getParamDesc() != null) {
			VALUES("param_desc", "#{paramDesc,jdbcType=VARCHAR}");
		}
	 ...
	 * @mbggenerated Fri Jun 08 18:04:10 CST 2018
	 */
	public String selectByExample(CscWltParameterExample example) {
		BEGIN();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		CscWltParameter record = (CscWltParameter) parameter.get("record");
		CscWltParameterExample example = (CscWltParameterExample) parameter.get("example");

		BEGIN();
		UPDATE("csc_wlt_parameter");
		...
		if (record.getParamDesc() != null) {
			SET("param_desc = #{record.paramDesc,jdbcType=VARCHAR}");
		}
	 ...
	 * @mbggenerated Fri Jun 08 18:04:10 CST 2018
	 */
	public String updateByPrimaryKeySelective(CscWltParameter record) {
		BEGIN();
		UPDATE("csc_wlt_parameter");
	 ...
	 * @mbggenerated Fri Jun 08 18:04:10 CST 2018
	 */
	protected void applyWhere(CscWltParameterExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
